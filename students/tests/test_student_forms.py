...
class TestStudentUpdateForm(TestCase):
    ...
    def test_form(self):
        ...
        self.client.login(username='igorko', password='x8wer3')
        ...
        self.assertIn('Student Update', response.content)
        ...
        self.assertIn('igorko.jpg', response.content)
    ...
    def test_success(self):
        ...
        self.assertEqual(response.redirect_chain[0][0],
            'http://testserver/?status_message=Student%20updated%20successfully!')
